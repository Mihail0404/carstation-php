...
<html lang="ru">
    <head>
        <title>Админ-панель - CarStation</title>
        <meta charset="utf-8" />
    ...
    <header class="header">
        ...
        <p class="headline">Админ-панель</p>
    <a href="/add.php"><button class="action-button" style="padding: 10px">Добавить товары</button></a>
    <a href="/delete.php"><button class="action-button" style="padding: 10px">Удалить товары</button></a>
    <footer>
